...
contract FundingToken is Token {
    ...
    function transfer(address to, uint value) override
        public
        returns (bool)
    {
    ...
    function transferFrom(address from, address to, uint value) override
        public
        returns (bool)
    {
    ...
    function approve(address spender, uint value) override
        public
        returns (bool)
    {
    ...
    function balanceOf(address owner) override
        public
        view
        returns (uint)
    {
